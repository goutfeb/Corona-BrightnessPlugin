...
function scene:create( event )
    ...
    text1 = display.newText( sceneGroup, "brightness.setBright(x) -- In this scene, brightness level has been reset to what it was before."
...
function scene:show( event )
    __brightness.setBright(__initialBrightLevel)
        ...
        if nextSceneButton then
        	...
        	function nextSceneButton:touch ( event )
              ...
              composer.removeScene("scene3")
        			composer.gotoScene( "scene0", { effect = "fade", time = 300 } )
        		end
        	end
